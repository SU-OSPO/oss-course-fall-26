...
*Note: This task requires that you have conda installed already.*

*Note: the first part of this tutorial uses bash, which is a shell program in
UNIX systems, such as MacOS or Linux. Windows users, you can install [WSL](https://learn.microsoft.com/en-us/windows/wsl/install), or
[git-scm](https://git-scm.com/install/windows) if you would like to use bash.*
